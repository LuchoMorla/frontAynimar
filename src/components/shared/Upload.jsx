  ...
  return (
    <>
      <button type="button" ref={waveRef} onClick={onOpen} className={'bg-slate-100 rounded p-2 flex-[100%] items-center flex flex-col '.concat(className)}>
        ...
        {blobImage.current ? `Archivo escogido: ${blobImage.current.name || 'Imagen tomada'}` : textButton}
      </button>
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  {!image ? (
                      ...
                      {isCamera ? (
                        <>
                          ...
                          <button
                            type="button"
                            ref={waveRef}
                            onClick={handlePressToggleCamera}
                            className="rounded py-2 flex items-center justify-center bg-teal-600 gap-2 text-foreground-100 font-semibold"
                            size="lg"
                          >
                        ...
                        <>
                          ...
                          <button
                            ...
                            ref={waveRef}
                            onClick={handlePressToggleCamera}
                            className="justify-center text-sm p-2 rounded-lg flex items-center bg-teal-600 gap-2 text-foreground-100 font-semibold"
                          >
                    ...
                    <>
                      ...
                      <button
                        ...
                        ref={waveRef}
                        className="flex items-center justify-center py-2 bg-teal-600 gap-2 text-foreground-100 font-semibold rounded-md px-2"
                        size="lg"
                      >
                ...
                <footer className="flex items-center gap-2 justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  <button type="button" className="text-red-600" onClick={onClose}>
                    Cancelar
                  </button>
                  <button type="button" ref={waveRef} className="bg-gray-800 text-slate-50 py-2 px-4 rounded" type="button" onClick={handleSubmitImage}>
                    Subir
                  </button>
                </footer>
              </div>
